...
fun trimAudioToMp3(
    ...
    mediaExtractor.seekTo(startMs * 1000, MediaExtractor.SEEK_TO_PREVIOUS_SYNC)
...
fun loadMusicFiles(callback: (List<File>) -> Unit) {
    ...
    val files = if (tabslifyDir.exists()) {
        tabslifyDir.listFiles()
...
class AudioRecorder {
    ...
    private fun reportError(message: String, throwable: Throwable, servicename: String) {
        com.tabslify.core.objects.reportError(
